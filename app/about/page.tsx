      ...
      <div className="flex-1">
        <div className="container py-8 space-y-8">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold tracking-tight">About NexusAI</h1>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="space-y-4">
              ...
              <p>
                At NexusAI, we're addressing the challenge of personalized media consumption in today's digital age.
            ...
            <div className="space-y-4">
              ...
              <p>
                NexusAI uses cutting-edge Graph Neural Networks to model user-content interactions as a graph, where
          ...
          <div className="space-y-4">
            ...
            <p>
              NexusAI was founded by a team of AI researchers, data scientists, and UX designers passionate about
